...
//     const response = [];
//
//     function pushToResponse(leftMost) {
//         if (JSON.stringify(leftMost) === JSON.stringify([x, y])) response.push(leftMost)
//     }
//
//     const leftMost = [x > 0 ? x - 1 : x, y];
//     const rightMost = [x < size - 1 ? x + 1 : x, y];
//     const upperMost = [x, y > 0 ? y - 1 : y];
//     const lowerMost = [x, y < size - 2 ? y + 1 : y];
//
//     pushToResponse(leftMost);
//     pushToResponse(rightMost);
//     pushToResponse(upperMost);
//     pushToResponse(lowerMost);
